...
export default function Home() {
  return (
    <main
      lang="uk"
      className="flex flex-1 items-center px-6 py-16 sm:px-10 lg:px-16"
    >
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="space-y-5">
          ...
          <p className="max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            ...
            Львівського ІТ коледжу. Тут ми спрощуємо щоденні завдання й
            організацію навчального процесу, щоб зосередитися на головному.
          </p>
        </div>
